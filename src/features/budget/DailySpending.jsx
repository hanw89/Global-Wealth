...
const MoneyManagement = () => {
  ...
  const [expenseCategories, setExpenseCategories] = useState([
    { id: 1, category: 'Food', amountUsd: 450.00, icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z', color: 'text-emerald-600', bg: 'bg-emerald-50', darkBg: 'dark:bg-emerald-900/20' },
    { id: 2, category: 'Living Expense', amountUsd: 1200.00, icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', color: 'text-blue-600', bg: 'bg-blue-50', darkBg: 'dark:bg-blue-900/20' },
    { id: 3, category: 'Transport', amountUsd: 200.00, icon: 'M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 100 2 1 1 0 000-2zm7 0a1 1 0 100 2 1 1 0 000-2z', color: 'text-indigo-600', bg: 'bg-indigo-50', darkBg: 'dark:bg-indigo-900/20' },
    { id: 4, category: 'Travel', amountUsd: 0, icon: 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.065M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4M9 21h6', color: 'text-cyan-600', bg: 'bg-cyan-50', darkBg: 'dark:bg-cyan-900/20' },
    { id: 5, category: 'Gift', amountUsd: 50.00, icon: 'M20 12V8H4v4m16 0a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4a2 2 0 012-2m16 0h-16', color: 'text-rose-600', bg: 'bg-rose-50', darkBg: 'dark:bg-rose-900/20' },
    { id: 6, category: 'Education', amountUsd: 100.00, icon: 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222', color: 'text-purple-600', bg: 'bg-purple-50', darkBg: 'dark:bg-purple-900/20' },
    { id: 7, category: 'Medical', amountUsd: 80.00, icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', color: 'text-red-600', bg: 'bg-red-50', darkBg: 'dark:bg-red-900/20' },
    { id: 8, category: 'Subscription', amountUsd: 120.00, icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', color: 'text-orange-600', bg: 'bg-orange-50', darkBg: 'dark:bg-orange-900/20' },
  ]);

  const [incomeCategories, setIncomeCategories] = useState([
    { id: 101, category: 'Salary', amountUsd: 5000.00, icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M12 16V15', color: 'text-green-600', bg: 'bg-green-50', darkBg: 'dark:bg-green-900/20' },
    { id: 102, category: 'Freelance', amountUsd: 800.00, icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', color: 'text-teal-600', bg: 'bg-teal-50', darkBg: 'dark:bg-teal-900/20' },
    { id: 103, category: 'Investments', amountUsd: 350.00, icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', color: 'text-blue-600', bg: 'bg-blue-50', darkBg: 'dark:bg-blue-900/20' },
  ]);
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <main className="flex-1 space-y-6">
          ...
          <div className="mt-12">
            ...
            <ExpenseLog activeTab={activeTab} categories={activeCategories.map(c => c.category)} />
          </div>
        </main>
      </div>
    </div>
